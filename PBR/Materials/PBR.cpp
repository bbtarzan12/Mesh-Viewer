...
void PBR::DrawUI()
{
	...
	{
		ImGui::ColorPicker4("##AlbedoColor", &defaultColors[2].r);
	...
	if (!DrawTexturePannel("metallicTexture", { 300, 100 }))
	{
		ImGui::Text("Metallic");
		ImGui::SameLine();
		ImGui::SliderFloat("##Metallic", &defaultColors[4].r, 0, 1);
		ImGui::EndChild();
	}
	...
	if (!DrawTexturePannel("roughnessTexture", { 300, 100 }))
	{
		...
		ImGui::SameLine();
		ImGui::SliderFloat("##Roughness", &defaultColors[5].r, 0, 1);
		ImGui::EndChild();
	}
	...
	if (!DrawTexturePannel("aoTexture", { 300, 100 }))
	{
		ImGui::Text("AO");
		ImGui::SameLine();
		ImGui::SliderFloat("##AO", &defaultColors[6].r, 0, 1);
		ImGui::EndChild();
	}
}
